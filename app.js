...
function initMap() {
    ...
    var contentString = '<div id="infowindow-content"><div id="title"><b>' + place.name + '</b></div>' + place.address + '</div>' + self.foursquareURL;
                    ...
                    function fourSquare() {
                        ...
                        function myViewModel() {
                            ...
                            this.filteredList = ko.computed(function() {
                                    ...
                                    if (!filter) {
                                        myLocations.forEach(function(locationItem) locationItem.visible(true)
                                        })
